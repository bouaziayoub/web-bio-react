...
function Card({ title, description, image }) {
  //  When the scroll reach to the card, the card will slide from the top
  ...
  return (
    <>
      {/* When the position reacht then set the classNaem with scroll */}
      <div className={position > 40 ? "slide-bck-top" : ""}>
